...
- [X] T021 [US4] Review the final diff, mark all completed tasks, commit, push only to `origin`, create draft Perego PR [#9](https://github.com/MustafaShaaban/perego/pull/9), and inspect its CI. The PR targets `feature/002-home`; GitHub reports no configured checks for this branch.
