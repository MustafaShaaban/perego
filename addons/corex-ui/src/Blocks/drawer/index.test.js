/**
 * Jest test for corex/drawer's EDITOR registration (spec 068 US9) — guards the contract every
 * corex/* dynamic block follows: registers under its block.json name, previews the server render
 * via <ServerSideRender>, and saves nothing (server-rendered). The @wordpress/* editor packages
 * and the SCSS import are virtual-mocked so the module loads headlessly.
 */
