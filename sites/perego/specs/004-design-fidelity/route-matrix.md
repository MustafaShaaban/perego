...
| --- | --- | --- | --- | --- |
| `index.html` | `/` / `front-page.html` | EN+AR, desktop+mobile; header, preloader, hero, about, services, clients, footer | Perego delivery | In review — 11/13 differences resolved (see [evidence/home.md](./evidence/home.md)); open: clients layout + AR content (row 5) |
