/**
 * Markup-parity test for the media-lightbox live-canvas block (spec 021 C15).
 *
...
const fixtureHtml = readFileSync( join( __dirname, '__fixtures__', 'front-media-lightbox.html' ), 'utf8' );

describe( 'media-lightbox markup parity', () => {
	test( 'the editor skeleton matches the PHP front-end markup', () => {
		expect( normalizeMarkup( renderToString( <MediaLightboxSkeleton /> ) ) )
