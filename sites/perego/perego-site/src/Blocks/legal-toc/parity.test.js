/**
 * Markup-parity test for the legal-toc live-canvas block (spec 021 C15).
 *
...
const fixtureHtml = readFileSync( join( __dirname, '__fixtures__', 'front-legal-toc.html' ), 'utf8' );

describe( 'legal-toc markup parity', () => {
	test( 'the editor skeleton matches the PHP front-end markup', () => {
		expect( normalizeMarkup( renderToString( <LegalTocSkeleton /> ) ) )
