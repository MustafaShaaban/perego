...
| 014 | Work archive + project single | `feature/014-work-project-pages` | **DONE** (PR pending) — project pages already CPT-editable (H1←title, meta←spec-010 boxes, body←post-content, grid/nav←Project CPT); added the deferred **gallery wp.media picker**; work archive + project single fidelity verified EN/AR |
